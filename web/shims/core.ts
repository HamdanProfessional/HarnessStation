...
const UNAVAILABLE: Record<string, string> = {
  ...
  python_run: "Running Python needs the in-browser VM, which isn't loaded in this build yet.",
  python_schema: "Python tools need the in-browser VM, which isn't loaded in this build yet.",
